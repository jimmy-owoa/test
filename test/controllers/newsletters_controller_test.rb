...
class NewslettersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post newsletters_url, params: { newsletter: { description: @newsletter.description, title: @newsletter.title } }
    end
  ...
  test "should update newsletter" do
    patch newsletter_url(@newsletter), params: { newsletter: { description: @newsletter.description, title: @newsletter.title } }
